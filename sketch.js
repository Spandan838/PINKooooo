...
function draw() {
  background(255);
  if(frameCount % 10 === 0){
    particle = new Particle(random(100, 300), 0, 7, random(0, 360));
    particles.push(particle);
  }

  if(frameCount % 10 === 0){
    particle = new Particle(random(700, 300), 0, 7, random(0, 360));
    particles.push(particle);
  }
  if(frameCount % 10 === 0){
    particle = new Particle(random(450, 300), 0, 7, random(0, 360));
    particles.push(particle);
  }

  if(frameCount % 10 === 0){
    particle = new Particle(random(780, 300), 0, 7, random(0, 360));
    particles.push(particle);
  }
